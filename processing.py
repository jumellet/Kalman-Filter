...
def vect_uv(angle_scan):
        ...
        #vecH1_loc = [-sin(angle_scan[0]), 0, cos(angle_scan[0])]
        #vecV1_loc = [sin(angle_scan[1]), cos(angle_scan[1]), 0]
        ...
        #vecH2_loc = [-sin(angle_scan[2]), 0, cos(angle_scan[2])]
        #vecV2_loc = [sin(angle_scan[3]), cos(angle_scan[3]), 0]
